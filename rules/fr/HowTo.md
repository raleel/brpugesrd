...
3. Vous pouvez effectuer tout ce processus via le navigateur sans connaître git. Cependant, apprendre à utiliser GitHub Desktop vous permettra de tester vos modifications localement avant de les déployer en ligne pour le monde entier.
...
Il faudra entre 5 et 30 secondes pour copier le modèle, puis vous aurez votre propre copie.
...
Il s'agit de votre menu, le panneau de navigation sur le côté gauche du site web. Une fois que vous avez ajouté un fichier markdown à votre dépôt, vous devez ajouter le fichier ici afin que son contenu soit inclus. Suivez la mise en forme existante.
...
3. Si vous n'avez pas rendu le dépôt 'public', vous avez deux choix :
    ...
    b. Mettre à niveau votre compte Github (au moment de la rédaction de ce guide, cela coûte 4 $ par mois ou 48 $ par an)

4. Sous 'Branch', sélectionnez 'main' et cliquez sur save

5. Attendez 10-20 secondes, puis actualisez la page
